...
6. Kopyaladığınız bu metnin tamamını (veya sadece başlıkları) bu `headers.txt` dosyasının içine yapıştırın ve kaydedin. *(Not: Uygulama başlatıldığında bu dosyayı okuyup sisteme giriş yapacaktır).*
